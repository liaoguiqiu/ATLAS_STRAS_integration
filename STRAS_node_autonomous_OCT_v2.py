...
class node():
  def __init__(self):
    ...
    self.output_path = "/home/lucas/atlas_work/code/integration/outputs/experiments/exp1"
    ...
    self.proportionalGain = 1/150.  # between 500-2000
    self.eps = 5
    self.cutoff = 1
    self.trans_P1 = 15
    self.trans_P2 = 0
  ...
  def callback_oct_dis(self,data):
    ...
    self.dy =   self.current_oct_dis  - target_y - self.current_oct_contact    # this is horizontal 
    ...
    if self.state_flag:
      ...
      self.octDistList.append(self.current_oct_contact)
      self.dxv.append(0) # this is temp removed by qiu
      self.dyv.append(0) # this is temp removed by qiu
      self.b1v.append(b1)
      self.b2v.append(b2)
      self.tv.append(t)
      self.rv.append(r)
      ...
      dict_movement = {"ts": self.times_v,
                       ...
                       "octDistContact":self.current_oct_contact,
                       "dx":self.dxList,
                       "dy":self.dyList,
                       "dxv":self.dxv,
                       "dyv":self.dyv,
      ...
      dict_movement.to_csv(os.path.join(self.output_path,"OCT-test-01.csv"))  
    ...
    if time_stamp > self.move_time:
      ...
      # targetx = kine_state[1] - self.proportionalGain*self.dx
      # targety = kine_state[0] - self.proportionalGain*self.dy
      
      targety =     kine_state[6]  + self.proportionalGain*self.dy
      ...
      if  self.state_flag:
        ...
        outputCommand.append(['BR', kine_state_updated[6], 0.05 ])
        print(outputCommand)

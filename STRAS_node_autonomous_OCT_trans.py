...
class node():
  def __init__(self):
    ...
    self.gain = 1/150.  # between 500-2000
    self.eps = 5
    self.cutoff = 1
    self.trans_P1 = 17
    self.trans_P2 = 5
  ...
  def callback_oct_dis(self,data):
    ...
    if self.state_flag:
      ...
      self.dxv.append(0) # thsi is temp removed by qiu
      self.dyv.append(0) # thsi is temp removed by qiu
      self.b1v.append(b1)
      self.b2v.append(b2)
      self.tv.append(t)
      self.rv.append(r)
    ...
    if time_stamp > self.move_time:
      ...
      targety =     kine_state[9]  + self.gain*self.dy
      ...
      if  self.state_flag:
        ...
        kine_state_updated[9] =  0 # straight
        ...
        outputCommand.append(['TR', kine_state_updated[4], 0.3 ])
        outputCommand.append(['BL', kine_state_updated[9], 0.1 ])
        print(outputCommand)
